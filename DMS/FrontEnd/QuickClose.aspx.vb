Partial Class FrontEnd_RootCauseReview
    ...
    Protected Sub btnCloseDT_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCloseDT.Click
        ...
        If DTType = 2 And DateDiff(DateInterval.Minute, CDate(lblDowntimeStart.Text), Now()) < 3 Then

            'close downtime without authorisation

            '1) Update the Loc table
            ...
            '2) close the downtime

            Dim dtadap As New DowntimeTableAdapters.QueriesTableAdapter
            dtadap.UpdateDowntimeAtClose(TxtPopTime.Text, Request.QueryString("RemedyID"), 0, 0, 0, Request.QueryString("downtimeID"))

            '3) Update the downtimeemailsent field in the locations table
