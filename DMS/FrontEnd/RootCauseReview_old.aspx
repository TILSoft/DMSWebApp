<%@ Page Language="VB" MasterPageFile="~/FrontEnd.master" AutoEventWireup="false"
    CodeFile="RootCauseReview_old.aspx.vb" Inherits="FrontEnd_RootCauseReview" Title="Untitled Page" %>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                            DataSourceID="RootRemODS" Width="100%" AllowPaging="True">
                                                            <Columns>
                                                        ...
                                                        <cc1:ModalPopupExtender ID="MPESymptom" runat="server" DynamicServicePath="" Enabled="True"
                                                            PopupControlID="pnlnewSymptom" TargetControlID="lnkHdnPop">
                                                        ...
                                                        <asp:Panel ID="pnlNewSymptom" runat="server" BackColor="#66CCFF">
                                                            <table class="style1">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:ObjectDataSource ID="ODSSymptom" runat="server" DeleteMethod="Delete" InsertMethod="Insert"
                                                                            OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByLocIDnotDTType"
                                                                            ...
                                                                            <SelectParameters>
                                                                                <asp:ControlParameter ControlID="lblSympID" Name="LocID" PropertyName="Text" Type="Int32" />
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td valign="top">
                                                                        ...
                                                                        <asp:DataList ID="DataList2" runat="server" DataKeyField="SymptomID" DataSourceID="ODSSymptom"
                                                                            Width="100%">
                                                                            <ItemTemplate>
                                                                                <asp:Button ID="Button2" runat="server" CommandArgument='<%# Eval("SymptomID") %>'
                                                                                    Text='<%# Eval("SymptomDesc") %>' Visible='<%# Eval("SymptomEnabled") %>' Width="100%" />
                                                                            </ItemTemplate>
                                                                        </asp:DataList>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        2. Select new symptom Description
                                                                    </td>
                                                                    <td>
                                                                        &nbsp;
                                                                    </td>
                                                                ...
                                                                <ContentTemplate>
                                                                    <table class="style1">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="TxtPopTime" runat="server" Font-Bold="True" ForeColor="#FF3300"></asp:TextBox><cc1:MaskedEditExtender
                                                                                    ID="MaskedEditExtender6" runat="server" CultureName="en-CA" ErrorTooltipEnabled="True"
                                                                                    Mask="99/99/9999 99:99:99" MaskType="DateTime" TargetControlID="txtPopTime" />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="2">
