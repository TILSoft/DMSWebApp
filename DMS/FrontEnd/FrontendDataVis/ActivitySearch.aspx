<%@ Page Language="VB" MasterPageFile= "~/FrontEnd.master" AutoEventWireup="false" CodeFile="ActivitySearch.aspx.vb" Inherits="DataVisualisation_ActivitySearch" title="Untitled Page" %>
...
<asp:BoundField DataField="ActualActivitytime" HeaderText="Activity time (mins)" 
                        ...
                        <asp:BoundField DataField="actdowntime" HeaderText="Downtime (mins)" 
                            SortExpression="actdowntime" />
