...
Partial Class zAdministration_EditRemedyRootcause2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim pathhelp As New Helpers
        'lblPath.Text = pathhelp.getlocpathnolink(DetailsView2.DataKey.Value, 0)
    ...
    Protected Sub BtnUpdateRCLoc_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnUpdateRCLoc.Click
        ...
        Dim pathhelp As New Helpers
        lblPath.Text = pathhelp.getlocpathnolink(Session("editBtnLocID"), 0)
    ...
    Protected Sub ODSRootCause_Selecting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceSelectingEventArgs) Handles ODSRootCause.Selecting
