                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%# Eval("RemedyID") %>'
                                                                            OnClick="LinkButton2_Click" Visible='<%# Eval("SymptomQuickClose") %>'>Quick Close</asp:LinkButton></ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                            <EmptyDataTemplate>
                                                ...
                                                <tr>
                                                    <td align="center" colspan="2">
                                                        <asp:Panel ID="pnlLogin" runat="server" BackColor="#99CCFF" DefaultButton = "btnlogok">
                                                                ...
                                                                <ContentTemplate>
                                                                    <table class="style1">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="TxtPopTime" runat="server" ForeColor="#FF3300" 
                                                                                    Font-Bold="True"></asp:TextBox><cc1:MaskedEditExtender
                                                            ...
                                                            <asp:ObjectDataSource ID="ODSDowntimeChecker" runat="server" 
                                                                OldValuesParameterFormatString="original_{0}" 
                                                                SelectMethod="GetDataByStartAndEnd" 
                                                                TypeName="DowntimeTableAdapters.DowntimeCheckerTableAdapter">
                                                                <SelectParameters>
                                                                    <asp:SessionParameter Name="SympLocid" SessionField="workstationID" 
                                                                        Type="Int32" />
