<%@ Page Language="VB" MasterPageFile="~/wshome.master" AutoEventWireup="false" CodeFile="WSHome090715.aspx.vb"
...
<table class="style1"><tr><td>Chart </td></tr><tr><td align="center"><dotnetCHARTING:Chart 
        ...
        SpacingPercentageNested="4" StartDateOfYear="" TempDirectory="charttemp" 
                                ...
                                <cc1:TabPanel runat="server" ID="TabPanel3" HeaderText="Time Line">
                                    <ContentTemplate>
<table class="style1"><tr height="50px"><td></td>
    <td>Downtime <uc2:TimeLine2 ID="WUCDT" runat="server" Width="450"></uc2:TimeLine2>
</td></tr><tr height="50px"><td></td>
        <td>Lot/CO &#160;<uc2:TimeLine2 ID="WUCLot" runat="server" Width="450"></uc2:TimeLine2>
</td></tr><tr height="50px"><td></td>
        <td>Shift &#160;<uc2:TimeLine2 ID="WUCShift" runat="server" Width="450"></uc2:TimeLine2>
</td></tr><tr height="50px"><td colspan="2"><table class="style2">
