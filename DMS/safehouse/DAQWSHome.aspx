...
<head runat="server">
    <title>Test Bed for DAQ Time line</title>
    <style type="text/css">
    ...
    <div>
        <table class="style1">
            <tr>
                <td colspan="2">
                    <h1>
                        DMS VERSION 3.2<cc1:ToolkitScriptManager ID="ToolkitScriptManager1" 
                            runat="server">
                ...
                <td align="left">
                    ...
                    <Items>
                        <asp:MenuItem Text="Data Analysis" Value="Data Analysis">
                            ...
                            <asp:MenuItem NavigateUrl="~/FrontEnd/FrontendDataVis/MultiViewtimeline.aspx" 
        ...
        <table class="style1">
            <tr>
                ...
                <td width="20%" colspan="2">
                    <asp:LinkButton ID="lnkManualDowntime" runat="server" Visible="False">Start a 
                    Manual downtime</asp:LinkButton>
                </td>
                <td>
                ...
                <td>
                    <asp:Panel ID="pnlSSImage" runat="server" BackColor="#CCCCCC" Width="700px">
                        <table class="style3">
                            <tr>
                                <td>
                                    Please click the location where the issue occured</td>
                            </tr>
                            <tr>
                                <td align="center">
