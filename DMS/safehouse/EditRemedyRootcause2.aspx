<%@ Page Language="VB" MasterPageFile="~/Backend.master" AutoEventWireup="false" CodeFile="EditRemedyRootcause2.aspx.vb" Inherits="zAdministration_EditRemedyRootcause2" title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="style1">
        ...
        <tr>
            <td colspan="2">
                <asp:DetailsView ID="DetailsView2" runat="server" AutoGenerateRows="False" 
                    DataKeyNames="RootCauseLocID" DataSourceID="ODSRootCause" DefaultMode="Edit" 
        ...
        <tr>
            <td width="30%">
                Root cause location</td>
            <td>
                <asp:Label ID="lblPath" runat="server" Font-Bold="True"></asp:Label>
                                    </td>
        </tr>
        </table>
                            <p>
