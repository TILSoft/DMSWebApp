<%@ Page Language="VB" MasterPageFile="~/FrontEnd.master" AutoEventWireup="false" CodeFile="OEEPyramidByLotByMachine.aspx.vb" Inherits="FrontEnd_DataAnalysis_Default" title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td colspan="3">
            <h2>
                OEE pyramid by Lot</h2>
        </td>
    </tr>
    <tr>
        <td colspan="3">
            Select the machine :<asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" 
...
<Label Color="Black"></Label>
        ...
        <td align="center">
            <dotnetCHARTING:Chart ID="ChartPerf" runat="server" style="width: 14px" 
                Width="400px" TempDirectory="ChartTemp">
<SmartForecast Start=""></SmartForecast>
        ...
        <td align="center" colspan="3">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="OperationRatePerMin" HeaderText="OperationRatePerMin" 
            ...
            <asp:ObjectDataSource ID="ODSOEE" runat="server" 
                ...
                TypeName="DataAnalysisOverallTableAdapters.tblLotTableAdapter">
                <SelectParameters>
