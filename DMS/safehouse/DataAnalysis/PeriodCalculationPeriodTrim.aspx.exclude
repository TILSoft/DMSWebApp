<%@ Page Language="VB" MasterPageFile="~/FrontEnd.master" AutoEventWireup="false" CodeFile="PeriodCalculationPeriodTrim.aspx.vb" Inherits="FrontEnd_DataAnalysis_PeriodCalculation" title="Untitled Page" %>
                ...
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="LotShiftID" HeaderText="LotShiftID" 
                            SortExpression="LotShiftID" InsertVisible="False" ReadOnly="True" />
                    </Columns>
                </asp:GridView>
                <asp:ObjectDataSource ID="LotsODS" runat="server" 
                    OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" 
                    TypeName="DataAnalysisTableAdapters.TrimmedLotsAndCOsByPeriodTableAdapter">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="txtLocID" Name="LocID" PropertyName="Text" 
                            Type="Int32" />
                        <asp:ControlParameter ControlID="txtStartTime" Name="PeriodStart" 
                            PropertyName="Text" Type="DateTime" />
                        <asp:ControlParameter ControlID="txtEndTime" Name="PeriodEnd" PropertyName="Text" 
                            Type="DateTime" />
                    </SelectParameters>
                </asp:ObjectDataSource>
            </td>
        ...
        <tr>
            <td colspan="3">
                <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="trimDowntimeID" HeaderText="trimDowntimeID" 
                            InsertVisible="False" ReadOnly="True" SortExpression="trimDowntimeID" />
                ...
                <asp:ObjectDataSource ID="downtimeODS" runat="server" 
                    OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" 
                    TypeName="DataAnalysisTableAdapters.TrimmedDowntimesByPeriodTableAdapter">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="txtLocID" Name="LocID" PropertyName="Text" 
                            Type="Int32" />
