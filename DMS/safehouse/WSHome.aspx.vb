...
Partial Class FrontEnd_WSHome
    ...
    Protected Sub btnSHOK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSHOK.Click
        ...
        ElseIf usercount > 0 Then
            ...
            odsShiftHandover.InsertParameters("Lineid").DefaultValue = Session("WorkstationID")
            odsShiftHandover.InsertParameters("EntryTime").DefaultValue = Now()
            odsShiftHandover.InsertParameters("userid").DefaultValue = useridno
