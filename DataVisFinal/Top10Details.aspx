    ...
    <table class="style1">
        ...
        <tr>
            <td>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="DowntimeID" 
                            DataNavigateUrlFormatString="../zadministration/editdowntime.aspx?downtimeid={0}" 
                ...
                <br />
                <br />
                Total downtime is downtime trimmed to the shift time in which it was occuring<br />
                <br />
                shift&nbsp; -----&nbsp;&nbsp;&nbsp;&nbsp; -----&nbsp;&nbsp;&nbsp;&nbsp; -----&nbsp;&nbsp;&nbsp;&nbsp; 
                -----<br />
                DT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; *********<br />
                <br />
                The example above would only register 4 units of downtime as it only coincided 
                with the shift for 4 units<br />
                <br />
            </td>
        </tr>
    </table>
