...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="style1" align="center">
                ...
                <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" 
                    ...
                    <cc1:TabPanel runat="server" HeaderText="Downtime Chart" ID="TabPanel1">
                        <ContentTemplate><dotnetCHARTING:Chart ID="Chart1" runat="server" ChartAreaSpacing="0" 
                                ...
                                TempDirectory="ChartTemp" Width="800px" Use3D="True" 
                    ...
                    <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="Downtime Details">
                        ...
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
                                ...
                                DataSourceID="ODSDTdescByLocID" Width="100%"><Columns><asp:BoundField DataField="Downtimestart" HeaderText="Downtimestart" 
                                        SortExpression="Downtimestart" /><asp:BoundField 
                                    DataField="Downtimeend" HeaderText="Downtimeend" SortExpression="Downtimeend" /><asp:BoundField 
                                    DataField="RemedyDescription" HeaderText="RemedyDescription" 
                                        SortExpression="RemedyDescription" /><asp:BoundField DataField="RootCauseDesc" HeaderText="RootCauseDesc" 
                                        SortExpression="RootCauseDesc" /><asp:BoundField 
                                    DataField="LocDescription" HeaderText="LocDescription" 
                                        SortExpression="LocDescription" /><asp:BoundField 
                                    DataField="SymptomDesc" HeaderText="SymptomDesc" SortExpression="SymptomDesc" /><asp:BoundField 
                                    DataField="totalDowntime" HeaderText="totalDowntime" ReadOnly="True" 
                                    SortExpression="totalDowntime" /><asp:BoundField DataField="ShiftDowntime" 
                                    HeaderText="ShiftDowntime" ReadOnly="True" SortExpression="ShiftDowntime" /></Columns>
                            <EmptyDataTemplate>
                                There are no downtimes for this selection
                            </EmptyDataTemplate>
                                ...
                                TypeName="DowntimeAnalysisTableAdapters.DetailsBasicByLocTableAdapter"><SelectParameters><asp:SessionParameter Name="locid" SessionField="DTLocID" Type="Int32" /><asp:ControlParameter 
                                        ...
                                        Type="String" />
                                </SelectParameters></asp:ObjectDataSource><br />note:&#160; total downtime may differ from downtime chart as downtime in this table is selected on the basis that it starts in the period defined.&#160; Hence it may overlap the period defined.</ContentTemplate>
                    </cc1:TabPanel>
                        ...
                        <ContentTemplate><asp:GridView ID="GridView3" runat="server" 
                                ...
                                Width="100%"><Columns><asp:BoundField DataField="LocDescription" 
                                    ...
                                    SortExpression="NoteDate" /></Columns>
                            <EmptyDataTemplate>
                                There are no engineering notes entered for this location
                            </EmptyDataTemplate>
                            </asp:GridView><asp:ObjectDataSource ID="ODSEngNotes" runat="server" 
        ...
        <tr>
            <td colspan="4" width="50%" align="center" valign="top">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    DataSourceID="ODSDTbyParentLoc" AllowSorting="True">
                    <Columns>
