        ...
        <tr>
            ...
            <td>
                <table class="style2">
                    ...
                    <tr>
                        <td>
                            <asp:RadioButtonList runat="server" RepeatDirection="Horizontal" AutoPostBack="True" ID="rblSelectQuery">
                ...
                <asp:ControlParameter ControlID="lblQueryStart" Name="downtimstart" 
                    PropertyName="Text" Type="DateTime" >
                                ...
                                <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="Stats for shift">
                                    <ContentTemplate>
<table class="style1"><tr><td>Chart </td></tr><tr><td align="center"><dotnetCHARTING:Chart 
                                            ID="OEEChart" runat="server" DefaultCultureName="" 
        ...
        SpacingPercentageNested="4" StartDateOfYear="" TempDirectory="charttemp" 
                                                        Width="500px"><SmartForecast Start="" TimeSpan="00:00:00" /><DefaultElement><SmartLabel AbsolutePosition="0,0"></SmartLabel></DefaultElement><DefaultLegendBox CornerBottomRight="Cut" Padding="4"><HeaderEntry Visible="False"></HeaderEntry></DefaultLegendBox><NoDataLabel Text="No Data"></NoDataLabel><ChartArea CornerTopLeft="Square" StartDateOfYear=""><DefaultElement><DefaultSubValue><Line Length="4" /></DefaultSubValue><SmartLabel AbsolutePosition="0,0"></SmartLabel></DefaultElement><Label Font="Tahoma, 8pt"></Label><YAxis GaugeLabelMode="Default" GaugeNeedleType="One" TimeInterval="Minutes"><ScaleBreakLine Color="Gray" /><TimeScaleLabels MaximumRangeRows="4"></TimeScaleLabels><MinorTimeIntervalAdvanced Start="" TimeSpan="00:00:00" /><ZeroTick><Line Length="3" /></ZeroTick><DefaultTick><Line Length="3" /><Label Text="%Value"></Label></DefaultTick><TimeIntervalAdvanced Start="" TimeSpan="00:00:00" /><Label Alignment="Center" Font="Arial, 9pt, style=Bold" LineAlignment="Center"></Label></YAxis><XAxis GaugeLabelMode="Default" GaugeNeedleType="One" TimeInterval="Minutes"><ScaleBreakLine Color="Gray" /><TimeScaleLabels MaximumRangeRows="4"></TimeScaleLabels><MinorTimeIntervalAdvanced Start="" TimeSpan="00:00:00" /><ZeroTick><Line Length="3" /></ZeroTick><DefaultTick><Line Length="3" /><Label Text="%Value"></Label></DefaultTick><TimeIntervalAdvanced Start="" TimeSpan="00:00:00" /><Label Alignment="Center" Font="Arial, 9pt, style=Bold" LineAlignment="Center"></Label></XAxis><TitleBox Position="Left"><Label Color="Black"></Label></TitleBox><LegendBox CornerBottomRight="Cut" Orientation="TopRight" Padding="4" 
                                                                Visible="False"><HeaderEntry Name="Name" SortOrder="-1" Value="Value" Visible="False"><LabelStyle Font="Arial, 8pt, style=Bold" /></HeaderEntry></LegendBox></ChartArea><TitleBox Position="Left"><Label Color="Black"></Label></TitleBox></dotnetCHARTING:Chart></td></tr></table>
...
</td></tr><tr height="50px"><td><table class="style2">
            <tr><td align="center" colspan="2" width="20%">Time line Colour Key </td></tr>
            <tr><td class="style4" colspan="2" width="20%"></td></tr><tr>
                <td bgcolor="Red" width="20%">&#160;&#160;</td>
                <td>Downtime </td></tr><tr>
            <td bgcolor="Blue">&#160;&#160;</td>
            <td>Lot time </td></tr><tr>
            <td bgcolor="#660066">&#160;&#160;</td>
            <td>Change over time </td></tr>
            <tr><td bgcolor="#006600">&#160;&#160;</td>
                <td>Shift time </td></tr></table></td></tr></table>
                                ...
                                <cc1:TabPanel runat="server" ID="TabPanel4" HeaderText="Blister Count">
                                    <ContentTemplate>
<br /><table class="style1"><tr><td>Enter current blister count for this lot to calculate performance </td><td><asp:TextBox ID="txtBlisterCount" runat="server"></asp:TextBox></td><td><asp:Button ID="BtnBlisterCount" runat="server" Text="Go" /></td></tr><tr><td align="center" colspan="3"><asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="ActivityID"
                                                        DataSourceID="ODSLotPerfData" Height="50px" Width="100%"><FieldHeaderStyle HorizontalAlign="Left" /><Fields><asp:BoundField DataField="ActivityID" HeaderText="ID" InsertVisible="False" ReadOnly="True"
                                                                SortExpression="ActivityID" /><asp:BoundField DataField="txtID" HeaderText="Lot No" SortExpression="txtID" /><asp:BoundField DataField="activitytime" HeaderText="Lot time" ReadOnly="True" SortExpression="activitytime" /><asp:BoundField DataField="downtime" HeaderText="Lot downtime" ReadOnly="True" SortExpression="downtime" /><asp:BoundField DataField="StartTime" HeaderText="Lot Start time" SortExpression="StartTime" /><asp:BoundField DataField="endtime" HeaderText="Lot End time" SortExpression="endtime" /><asp:BoundField DataField="FormatDesc" HeaderText="Format" SortExpression="FormatDesc" /><asp:BoundField DataField="OperationRatePerMin" HeaderText="Format Rate" SortExpression="OperationRatePerMin" /><asp:BoundField DataField="GoodProduct" HeaderText="Good Product" SortExpression="GoodProduct" /><asp:BoundField DataField="TargetOutput" HeaderText="Target Output" SortExpression="TargetOutput" /><asp:BoundField DataField="Waste" HeaderText="Waste" SortExpression="Waste" /><asp:BoundField DataField="runningTime" HeaderText="Running Time" ReadOnly="True"
                                                                SortExpression="runningTime" /><asp:BoundField DataField="TheoreticalUnits" HeaderText="Theoretical Units" ReadOnly="True"
                                                                SortExpression="TheoreticalUnits" /><asp:BoundField DataField="Availability" HeaderText="Availability" ReadOnly="True"
                                                                SortExpression="Availability" /><asp:BoundField DataField="Performance" HeaderText="Performance" ReadOnly="True"
                                                                SortExpression="Performance" DataFormatString="{0:00.0}" /><asp:BoundField DataField="Quality" HeaderText="Quality" ReadOnly="True" SortExpression="Quality" /><asp:BoundField DataField="OEE" HeaderText="OEE" ReadOnly="True" SortExpression="OEE" /></Fields><HeaderStyle HorizontalAlign="Left" /><RowStyle HorizontalAlign="Left" /></asp:DetailsView><asp:ObjectDataSource ID="ODSLotPerfData" runat="server" OldValuesParameterFormatString="original_{0}"
                                                        SelectMethod="GetData" TypeName="PerformanceAnalysisTableAdapters.LotOEEDataTableAdapter"><SelectParameters><asp:Parameter DefaultValue="1" Name="activitytype" Type="Int32" /><asp:SessionParameter DefaultValue="" Name="ActivityID" SessionField="ActivityID"
                                                                Type="Int32" /></SelectParameters></asp:ObjectDataSource></td></tr></table>
...
<cc1:TabPanel HeaderText = "Shift Handover" runat = "server" ID = "tabpanel5">
    ...
    <table class="style4">
        <tr>
            <td align="left" valign="top">
                <asp:FormView ID="FormView1" runat="server" DataKeyNames="ShiftHandoverID" 
                    DataSourceID="odsShiftHand" Width="100%">
                    <EditItemTemplate>
                        ShiftHandoverID:
                        <asp:Label ID="ShiftHandoverIDLabel1" runat="server" 
                            Text='<%# Eval("ShiftHandoverID") %>' />
                        <br />
                        LineID:
                        ...
                        <table class="style2">
                            <tr>
                                <td width="10%">
                                    <b>EQUIPMENT</b></td>
                                <td>
                                    <asp:TextBox ID="field1TextBox" runat="server" Rows="5" 
                                        Text='<%# Bind("field1") %>' TextMode="MultiLine" Width="100%" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <b>PROCESS</b></td>
                                <td>
                                    <asp:TextBox ID="field2TextBox" runat="server" Rows="5" 
                                        Text='<%# Bind("field2") %>' TextMode="MultiLine" Width="100%" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <b>MATERIALS</b></td>
                                <td>
                                    <asp:TextBox ID="field3TextBox" runat="server" Rows="5" 
                                        Text='<%# Bind("field3") %>' TextMode="MultiLine" Width="100%" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <b>OTHER</b></td>
                                <td>
                                    <asp:TextBox ID="field4TextBox" runat="server" Rows="2" 
                                        Text='<%# Bind("field4") %>' TextMode="MultiLine" Width="100%" />
                                </td>
                            </tr>
                        </table>
...
&nbsp;<asp:LinkButton ID="InsertCancelButton" runat="server" CausesValidation="False" 
                    ...
                    <ItemTemplate>
                        Time:
                        <asp:Label ID="EntryTimeLabel" runat="server" Text='<%# Bind("EntryTime") %>' />
                        <br />
                        <b>EQUIPMENT</b>:
                ...
                <asp:ObjectDataSource ID="odsShiftHand" runat="server" DeleteMethod="Delete" 
                    ...
                    <SelectParameters>
                        <asp:SessionParameter DefaultValue="" Name="lineID" 
                            SessionField="WorkstationID" Type="Int32" />
                    </SelectParameters>
                    <InsertParameters>
                        <asp:Parameter Name="LineID" Type="Int32" />
                        <asp:Parameter Name="UserID" Type="Int32" />
