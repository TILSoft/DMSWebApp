<%@ Page Language="VB" MasterPageFile="~/FrontEnd.master" AutoEventWireup="false" CodeFile="MultiLineMultiFormat.aspx.vb" Inherits="FrontEnd_FrontendDataVis_MultiLineMultiFormat1" title="Untitled Page" %>
 ...
 <div>
        ...
        <table class="style1" width="100%">
            <tr>
                <td colspan="2">
                    <h3>
                    Multiline/Format Selection report</h3>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <table class="style1">
                <tr>
                    <td>
                        ...
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("LocID") %>' 
