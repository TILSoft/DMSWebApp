...
<asp:TemplateField HeaderText="Location Path"></asp:TemplateField>
                                ...
                                <tr __designer:mapid="130">
                                    <td __designer:mapid="131" align="center">
                                        <dotnetCHARTING:Chart runat="server" SpacingPercentage="16" 
                                            HotspotMinimumSize="0" SpacingPercentageNested="4" 
                                            FunnelNozzleWidthPercentage="35" FunnelSpacingPercentage="16" 
                                            ChartAreaSpacing="0" DefaultCultureName="" TempDirectory="ChartTemp" 
                                            Width="800px" Use3D="True" StartDateOfYear="" ID="Chart2" Height="600px">
