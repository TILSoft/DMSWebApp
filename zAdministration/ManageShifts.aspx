<%@ Page Language="VB" MasterPageFile="~/Backend.master" AutoEventWireup="false"
    CodeFile="ManageShifts.aspx.vb" Inherits="zAdministration_ManageShifts" Title="Untitled Page"  MaintainScrollPositionOnPostback="True" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="style1">
        <tr>
            <td>
                <h2>
                    Shift Pattern Management<cc1:ToolkitScriptManager ID="ToolkitScriptManager1" 
                        runat="server">
            ...
            ErrorTooltipEnabled="True" />
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                ControlToValidate="txtteam" ErrorMessage="You must enter a team">*</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            5.&nbsp; Hit the add Button</td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Button ID="btnAddShift" runat="server" Text="Add Shift" />
                            <br />
                    ...
                    <tr>
                        <td colspan="4" valign="top">
                            ...
                            <asp:ObjectDataSource ID="ShiftsOutputODS" runat="server" DeleteMethod="Delete" InsertMethod="Insert"
                                OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataBy" TypeName="ShiftsTableAdapters.tblShiftsTableAdapter"
                                UpdateMethod="Update">
                                <DeleteParameters>
                    ...
                    <tr>
                        <td colspan="4" valign="top">
                            6. When you have one shift cycle complete click                             
                            <asp:LinkButton ID="lnkShiftWiz" runat="server" CausesValidation="False">Shift Copy Wizard</asp:LinkButton>
                        &nbsp;to copy the cycle</td>
                    </tr>
                </table>
                <br />
                <br />
