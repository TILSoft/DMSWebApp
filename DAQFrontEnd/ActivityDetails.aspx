                ...
                <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" 
                    ...
                    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
                            DataKeyNames="ActivityID" DataSourceID="ODSActivity" Height="50px" Width="100%"><Fields><asp:BoundField DataField="ActivityID" HeaderText="Activity ID" 
                                    ...
                                    HeaderText="Shift Activity Time (mins)" SortExpression="ActualActivitytime" />
                            <asp:BoundField DataField="StdTime" HeaderText="Target Time" 
                                SortExpression="StdTime" />
                            <asp:BoundField DataField="txtID" HeaderText="Lot No / C/O start time" 
